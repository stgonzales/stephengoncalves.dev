...
function Card({ name, description, homepage,topics, language, html_url }: Card) {
  return (
    <Link href={html_url} target="_blank" className="w-full min-w-[327px] max-w-2xl border border-slate-300 shadow rounded-lg py-3 px-3 flex flex-col gap-3 hover:scale-105 transition-transform">
      <div>
